...
namespace ColorSpheres
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Sphere1 - Color: ({sphere1.Color.Red}, {sphere1.Color.Green}, {sphere1.Color.Blue}, {sphere1.Color.Alpha}), Radius: {sphere1.Radius}, Times Thrown: {sphere1.TimesThrown}");
            Console.WriteLine($"Sphere2 - Color: ({sphere2.Color.Red}, {sphere2.Color.Green}, {sphere2.Color.Blue}, {sphere2.Color.Alpha}), Radius: {sphere2.Radius}, Times Thrown: {sphere2.TimesThrown}");
        }
    }
}
